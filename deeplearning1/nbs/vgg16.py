...
class Vgg16():
    ...
    def fit(self, batches, val_batches, epochs=1):
        """
            ...
            See Keras documentation: https://keras.io/models/model/
        """
        print(val_batches.samples, val_batches.batch_size)
        print(int(val_batches.samples/val_batches.batch_size))
        self.model.fit_generator(batches, steps_per_epoch=batches.samples//batches.batch_size, epochs=epochs,
                validation_data=val_batches, validation_steps=int(val_batches.samples/min(val_batches.samples,val_batches.batch_size)))
